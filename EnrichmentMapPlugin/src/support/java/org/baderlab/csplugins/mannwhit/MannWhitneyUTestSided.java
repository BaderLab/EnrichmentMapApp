...
/* NOTICE
 * This file was modified from its original to include one-sided mann whitney test
 * for lesser and greater.
 */
package org.baderlab.csplugins.mannwhit; // had to change package name because we still include commons.math
 ...
 */
public class MannWhitneyUTestSided {
     ...
     */
    public MannWhitneyUTestSided(final NaNStrategy nanStrategy,
