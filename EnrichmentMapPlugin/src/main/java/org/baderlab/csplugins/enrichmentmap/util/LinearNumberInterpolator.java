 ...
 * org.cytoscape.view.vizmap.internal.mappings.interpolators.
 * LinearNumberInterpolator<br>
 * and<br>
 * org.cytoscape.view.vizmap.internal.mappings.interpolators.
 * LinearNumberToNumberInterpolator<br>
 *
 */
public class LinearNumberInterpolator {
	...
	/**
	 * Returns a new LinearNumberInterpolator with the following property: If a
	 * domain value is below the lowerDomain parameter then return lowerValue,
	 * if a domain value is above the upperDomain parameter then return
	 * upperValue.
	 */
