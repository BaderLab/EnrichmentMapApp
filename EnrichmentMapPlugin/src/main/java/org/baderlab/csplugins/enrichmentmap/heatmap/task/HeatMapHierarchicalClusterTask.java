...
public class HeatMapHierarchicalClusterTask extends AbstractTask implements ObservableTask{
    ...
    private TaskMonitor taskMonitor;
	 ...
	 public HeatMapHierarchicalClusterTask(int numConditions,
			int numConditions2,
     ...
     *
     * in the heatmap panel it sets the set of ranks based on the hierarchical clustering of the current expression set.
	 * @throws Exception 
     */
