...
import org.baderlab.csplugins.enrichmentmap.Enrichment_Map_Plugin.FileNameParts;
...
//    static JCheckBoxMenuItem overrideHeatmapRevalidationItem;
    ...
    public Enrichment_Map_Plugin_GSEA(){
        ...
        String pluginName = Enrichment_Map_Plugin.plugin_props.getProperty("pluginName","EnrichmentMap_gsea");
...
//        submenu.add(item);
    ...
    public static void setOverrideHeatmapRevalidation(
        ...
        Enrichment_Map_Plugin_GSEA.overrideHeatmapRevalidation = overrideHeatmapRevalidation;
    }
    ...
    private FileNameParts ParseFileName(String filename){
    		String[] fullname = filename.split("Enrichment_Map_Plugin_");
