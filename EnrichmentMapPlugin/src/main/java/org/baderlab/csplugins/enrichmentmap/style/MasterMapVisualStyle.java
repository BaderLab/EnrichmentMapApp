...
public class MasterMapVisualStyle {
	...
	private void setEdgeDefaults(VisualStyle vs, MasterMapStyleOptions options) {
		...
		DiscreteMapping<String, Paint> edgePaint = (DiscreteMapping<String, Paint>) vmfFactoryDiscrete
		...
		DiscreteMapping<String, Paint> edgeStrokePaint = (DiscreteMapping<String, Paint>) vmfFactoryDiscrete
