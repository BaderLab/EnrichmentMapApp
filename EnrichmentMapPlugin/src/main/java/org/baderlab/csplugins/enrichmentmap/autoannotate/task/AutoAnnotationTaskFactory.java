...
public class AutoAnnotationTaskFactory implements TaskFactory {
	...
	public AutoAnnotationTaskFactory(CySwingApplication application, CyApplicationManager applicationManager, CyNetworkViewManager networkViewManager,
	...
	public TaskIterator createTaskIterator() {
		return new TaskIterator(new AutoAnnotationTask(application, applicationManager, networkViewManager, networkManager, annotationManager, autoAnnotationManager, selectedView, clusterColumnName, nameColumnName, algorithm, annotationSetNumber, registrar, tableManager));
	}
