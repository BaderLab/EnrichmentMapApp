...
/**
 * Created by IntelliJ IDEA. User: User Date: 1/28/11 Time: 9:17 AM To change
...
public class BulkEMCreationPanel extends JPanel implements CytoPanelComponent {
	...
	/**
	 * Creates a collapsible panel that holds the different paths for the GMT
	 * and GCt file
	 *
	 * Only required when the user has moved the location of the these files and
	 * they are different than the ones defined in the RPT file
	 * 
	 * @return CollapsiblePanel
	 */
	...
	private CollapsiblePanel createDiffGMTGCTDirectory() {
		...
		selectGMTDirButton.addActionListener(new java.awt.event.ActionListener() {
		...
		selectGCTDirButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		public void propertyChange(PropertyChangeEvent e) {
			...
			if(source == pvalueTextField) {
				...
				if(value.equalsIgnoreCase(""))
					...
					JOptionPane.showMessageDialog(application.getJFrame(), message,
							"Directory name change entered is not a valid file name", JOptionPane.WARNING_MESSAGE);
	 ...
	 * @param evt
	 */
	private void selectGMTDirButtonActionPerformed(java.awt.event.ActionEvent evt) {
		// Create FileFilter
		FileChooserFilter filter = new FileChooserFilter("All GMT Files", "gmt");
	 ...
	 * @param evt
	 */
	private void selectGCTDirButtonActionPerformed(java.awt.event.ActionEvent evt) {
		// Create FileFilter
		FileChooserFilter filter = new FileChooserFilter("All GMT Files", "gmt");
		FileChooserFilter filter_gct = new FileChooserFilter("All GMT Files", "gct");
		FileChooserFilter filter_txt = new FileChooserFilter("All GMT Files", "txt");
	...
	private JPanel createAnalysisTypePanel() {
		...
		/*
		 * david.addActionListener(new java.awt.event.ActionListener() { public
		...
		panel.add(generic);
		/*
		 * c.gridy = 2; gridbag.setConstraints(david, c); panel.add(david);
		 */
	...
	private void selectAnalysisTypeActionPerformed(ActionEvent evt) {
		...
		/*
		 * else
		 * if(analysisType.equalsIgnoreCase(EnrichmentMapParameters.method_DAVID
