...
*/
public class GMTFileReader implements Task {
    ...
    private boolean interrupted = false;
     ...
     public GMTFileReader(EnrichmentMapParameters params, TaskMonitor taskMonitor) {
        this(params);
        this.taskMonitor = taskMonitor;
    }

    public GMTFileReader(EnrichmentMapParameters params)   {
        this.params = params;
