 ...
 * Time: 2:14:52 PM
*/
public class ComputeSimilarity implements Task {
    ...
    public ComputeSimilarity(EnrichmentMapParameters params, TaskMonitor taskMonitor) {
          this(params);
          this.taskMonitor = taskMonitor;
      }


    public ComputeSimilarity(EnrichmentMapParameters params) {
        this.params = params;
                    ...
                    //Check to see if this comparison has been done
                     ...
                     if(geneset1_name.equalsIgnoreCase(geneset2_name)){
                        ...
                        //Get the intersection
                         ...
                         GenesetSimilarity comparison = new GenesetSimilarity(geneset1_name,geneset2_name, jaccard_coeffecient,(HashSet<Integer>)intersection);
